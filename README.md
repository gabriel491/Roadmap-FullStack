...
O cronograma cobre **15 semanas** divididas em **4 módulos práticos**, com desafios reais para consolidação e construção de um portfólio de alto nível no GitHub.
...
| :--- | :--- | :--- | :--- |
| **Módulo 1: Transição para TypeScript e ES6+ Avançado** | Semanas 01 - 03 | Tipagem estática, Generics, Promises, Iterators, Reflect e Testes com Jest | **Refatoração TypeScript**: Migrar um app JS puro para TS com testes unitários |
| **Módulo 2: Ecossistema Front-End Profissional React** | Semanas 04 - 07 | Custom Hooks, Zustand/Context, Otimização (Memo, Callbacks), Bundlers, SEO e A11y | **Dashboard Interativo**: Painel performático consumindo API pública com Vite |
| **Módulo 3: Integração, Testes e Qualidade** | Semanas 08 - 11 | REST & SWR/React Query, GraphQL, Jest/RTL (TDD), OWASP Top 10 Web e CI/CD | **E-commerce Simplificado (Front)**: Interface de vendas com alta cobertura de testes e segurança |
| **Módulo 4: O Lado Back-End (Integração Eficiente)** | Semanas 12 - 15 | Node/Express (Middlewares, Joi, JWT), MongoDB (Mongoose, Pipelines), WebSockets | **API RESTful Completa**: Backend seguro e robusto integrado ao E-commerce |
